    ...
    <div>
      ...
      <Navigation />
        ...
        <div className='description mt-4'>
          <p>Parfait(ぱふぇ)は<strong>完全エンジョイでゲームをする数人で建てられたクラン</strong>です。</p>
          <p><strong>完全招待制</strong>のクランになっており、入るには運営人の承認が必要です。</p>
          <p>ゲームはコアなFPSからゆるいRPGなど幅広く気分で遊んでいます。</p>

          <h3 className='mt-5'><b>ぱふぇの由来</b></h3>
          <p>「Parfait」はフランス語で完璧という意味であり、甘く最高のデザートです。</p>
          <p>ゲーム内においても<b>強く</b>、そして<b>楽しいグループ</b>を目指して命名しました。</p>
        </div>
